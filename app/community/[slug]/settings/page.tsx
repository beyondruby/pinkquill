...
export default function CommunitySettingsPage() {
  ...
  const settingsOptions = [
    ...
    },
    {
      ...
      description: 'Configure welcome message and moderation chat behavior',
      href: `/community/${slug}/settings/chat`,
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Post Flairs',
      description: 'Create and manage post categories/tags',
      href: `/community/${slug}/settings/flairs`,
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
