    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
        ...
        <MetricCard
          ...
          previousValue={insights.previousPeriod.impressions}
        ...
        <MetricCard
          label="Interactions"
          value={insights.totalEngagement}
          description={`${formatNumber(insights.engagementBreakdown.reactions)} reactions`}
          icon={
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
