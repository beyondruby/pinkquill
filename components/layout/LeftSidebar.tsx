            ...
            {showMenu && (
              <div className={`absolute p-1.5 rounded-2xl bg-white/95 backdrop-blur-xl shadow-xl shadow-black/[0.08] border border-black/[0.06] z-50 animate-fadeIn ${
                ...
                >
                  ...
                  <span className="font-ui text-[0.9rem]">My Orders</span>
                </Link>
                ...
                >
                  <div className="relative">
                    ...
                    {cartCount > 0 && (
                      <span className="absolute -top-1.5 -right-2 min-w-[14px] h-[14px] bg-pink-vivid text-white font-ui text-[0.55rem] font-semibold rounded-full flex items-center justify-center px-0.5">
                        {cartCount > 99 ? '99+' : cartCount}
                      </span>
                    )}
                  </div>
                  <span className="font-ui text-[0.9rem]">Cart</span>
                </Link>
