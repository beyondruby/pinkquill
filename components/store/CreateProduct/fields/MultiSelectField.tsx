                ...
                {field.allowCustom && (
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2.5 rounded-lg text-sm text-left
                      transition-all duration-200 hover:bg-pink-vivid/5"
                  >
                    <svg className="w-4 h-4 text-pink-vivid" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                    </svg>
                    <span className="font-ui text-sm text-pink-vivid">Custom</span>
                  </button>
                )}
              </div>
          ...
          {value.map((val) => (
            ...
            >
              ...
              <button
                ...
                className="p-0.5 hover:bg-pink-vivid/10 rounded-full transition-colors"
              >
