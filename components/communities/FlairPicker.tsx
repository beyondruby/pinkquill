...
export default function FlairPicker({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center gap-2 px-3 py-2 rounded-lg border transition-colors ${
          disabled
            ...
            : "bg-white border-black/[0.08] hover:border-purple-primary/50 text-ink"
        }`}
      >
        {loading ? (
      ...
      {isOpen && (
        <div className="absolute z-50 mt-1 w-64 bg-white rounded-lg shadow-lg border border-black/[0.08] py-1 max-h-64 overflow-y-auto">
          ...
          {selectedFlairId && (
            <button
              ...
              className="w-full px-3 py-2 text-left text-sm text-muted hover:bg-black/[0.02] flex items-center gap-2"
            >
              <svg
                className="w-4 h-4"
                fill="none"
          ...
          {flairs.map((flair) => (
            <button
              ...
              className={`w-full px-3 py-2 text-left hover:bg-black/[0.02] flex items-center gap-2 ${
                selectedFlairId === flair.id ? "bg-purple-primary/[0.04]" : ""
              }`}
            >
