        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <div className="mt-8 sm:mt-10 flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-surface/15 backdrop-blur-sm rounded-full border border-white/20">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-sm font-ui font-medium text-white">{isService ? "Clear Package Pricing" : PRODUCT_FEE_LABEL}</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2.5 bg-surface/15 backdrop-blur-sm rounded-full border border-white/20">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
              ...
              <div className="relative w-full h-full rounded-3xl overflow-hidden border-4 border-white/20 shadow-2xl shadow-black/20 bg-surface/10 backdrop-blur-sm">
                <Image
