...
Started 2026-09-05 · baseline commit `e509c5a` · status: proof, foundations, shell, Phases 3–4 and 5A (communities directory and home) done; 5B community membership/settings next.
