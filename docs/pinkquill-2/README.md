...
Started 2026-09-05 · baseline commit `e509c5a` · status: proof, foundations, shell, Phases 3–4, 5A and 5B (communities, membership, moderation, settings) done; 5C messages and notifications next.
