...
Started 2026-09-05 · baseline commit `e509c5a` · status: proof, foundations, shell, Phases 3–5 (communities, membership, moderation, settings, messages, notifications) done; 6A public studio next.
