-- ============================================
-- CREATE ORDER FIRST, COLLECT SHIPPING IN DRAFT
-- ============================================
-- Physical product orders should be creatable without an address.
-- Shipping details are enforced later in finalize_order_payment.
